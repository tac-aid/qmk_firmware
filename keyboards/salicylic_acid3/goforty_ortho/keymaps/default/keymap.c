...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        KC_NO, KC_F1, KC_F2, KC_F3, KC_F4, KC_NO, KC_NO, KC_COLN, KC_1, KC_2, KC_3, KC_NO, KC_NO, 
    ...
    [2] = LAYOUT(
        KC_NO, KC_ASTR, KC_SLSH, KC_GRV, KC_DLR, KC_COMM, KC_NO, KC_DOT, KC_LBRC, KC_RBRC, KC_EXLM, KC_QUES, KC_NO, 
        KC_LCTL, KC_PLUS, KC_MINS, KC_DOUBLE_QUOTE, KC_EQL, KC_PERC, KC_NO, KC_AT, KC_LPRN, KC_RPRN, KC_LABK, KC_RABK, KC_NO,
        KC_NO, KC_CIRC, KC_TILD, KC_QUOT, KC_UNDS, KC_BSLS, KC_NO, KC_HASH, KC_LCBR, KC_RCBR, KC_AMPR, KC_PIPE, KC_NO,
        KC_NO, KC_NO, KC_LALT, KC_LGUI,   USER_2,   KC_SPC, KC_NO,   KC_NO,    KC_NO, KC_NO, KC_NO, KC_NO
    ),
    [3] = LAYOUT(
