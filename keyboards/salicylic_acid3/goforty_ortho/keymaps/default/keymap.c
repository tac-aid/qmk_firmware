...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT(
        _______, KC_ASTR, KC_SLSH, KC_GRV, KC_DLR, KC_COMM, KC_NO, KC_DOT, KC_LBRC, KC_RBRC, KC_EXLM, KC_QUES, _______, 
        KC_LCTL, KC_PLUS, KC_MINS, KC_DOUBLE_QUOTE, KC_EQL, KC_PERC, KC_NO, KC_AT, KC_LPRN, KC_RPRN, KC_LABK, KC_RABK, _______,
        _______, KC_CIRC, KC_TILD, KC_QUOT, KC_UNDS, KC_BSLS, KC_NO, KC_HASH, KC_LCBR, KC_RCBR, KC_AMPR, KC_PIPE, _______,
        _______, _______, KC_LALT, KC_LGUI,   USER_2,   KC_SPC, _______,   _______,    _______, _______, _______, _______
    ),
    [3] = LAYOUT(
